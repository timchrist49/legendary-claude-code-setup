...
echo ""
echo -e "  1. ${BOLD}Start a new terminal${NC} (or run: source ~/.bashrc)"
echo ""
echo -e "  2. ${BOLD}Authenticate Claude Code:${NC}"
echo "     $ claude"
...
echo ""
echo -e "  4. ${BOLD}Restart Claude Code${NC} to activate plugins"
echo ""
echo -e "  5. ${BOLD}For headless servers, start Xvfb:${NC}"
